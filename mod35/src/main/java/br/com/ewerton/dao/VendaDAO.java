...
import br.com.ewerton.dao.factory.ProdutoQuantidadeFactory;
import br.com.ewerton.dao.factory.VendaFactory;
import br.com.ewerton.dao.generic.GenericDAO;
import br.com.ewerton.dao.generic.jdbc.ConnectionFactory;
...
import static br.com.ewerton.dao.generic.jdbc.ConnectionFactory.getConnection;
...
public class VendaDAO extends GenericDAO<Venda, String> implements IVendaDAO {
    ...
    @Override
    public void alterar(Venda entity) throws TipoChaveNaoEncontradaException, DAOException {
    }
    ...
    public void cancelarVenda(Venda venda) throws TipoChaveNaoEncontradaException, DAOException {
        ...
        try (Connection connection = getConnection();
            ...
            throw new DAOException("Erro ao atualizar o status da venda para CANCELADA", e);
        }
    }
